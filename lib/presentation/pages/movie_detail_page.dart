...
class DetailContent extends StatelessWidget {
  ...
  DetailContent(this.movie, this.recommendations, this.isAddedWatchlisto);
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                if (message ==
                                        MovieDetailNotifier
                                            .watchlistoAddSuccessMessage ||
                                    message ==
                                        MovieDetailNotifier
                                            .watchlistoRemoveSuccessMessage) {
                            ...
                            Text(
                              ('${movie.numberOfEpisodes.toString()} Episodes'),
                            ),
                            Row(
                              children: [
                                RatingBarIndicator(
